        ...
        <div class="card card-outline card-purple shadow p-3 mb-5 bg-body rounded">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ url('/admin/roles/create') }}" class="btn btn-primary btn-sm"><i
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    @if ($rol->id != 1)
                                    <form class="btn-group" action="{{ url('/admin/roles', $rol->id) }}" method="post"
                                        onclick="pregunta{{ $rol->id }}(event)" id="formDelete{{ $rol->id }}">
                                        @csrf
                                        @method('DELETE')
