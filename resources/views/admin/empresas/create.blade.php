                                            ...
                                            reader.onload = (function(theFile) {
                                                return function(e) {
                                                    ...
                                                    document.getElementById("list").innerHTML = [
                                                        '<img class="thumb thumbail" src="', e
                                                        .target.result, '" width="90%" title="', escape(
                                                            theFile.name), '"/>'
                                                    ].join('');
                                                };
                                            })(f);
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nomImpuesto"
                                                name="nombre_impuesto" value="{{ old('nombre_impuesto') }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="valImpuesto"
                                                name="cantidad_impuesto" value="{{ old('cantidad_impuesto') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tipoEmpresa" name="tipo_empresa"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="telefonoEmpresa" name="telefono"
                                                value="{{ old('telefono') }}">
                                            @error('telefono')
                                            <small style="color: red">{{ $message }}</small>
                                            @enderror
