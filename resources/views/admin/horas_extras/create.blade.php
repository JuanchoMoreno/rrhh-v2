                ...
                <form id="horasExtrasForm" action="{{ url('/admin/horas_extras') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="usuario" value="{{ Auth::user()->name }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="correo" value="{{ Auth::user()->email }}"
                                    readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                {{-- <label for="estado">Estado</label> --}}
                                <a class="btn btn-primary btn-sm" id="addsection"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="horasExtrasTable" class="table table-striped table-hover table-sm">
                        ...
                        <tbody class="display-none" id="section_hrp1">
                            ...
                            <tr>
                                ...
                                <td class="col-md-2"><input type="date" class="form-control" name="fecha" id="fecha"
                                ...
                                <td><input type="number" class="form-control suma_horasExtras" name="ex_diur_festdomin"
                                        placeholder="0" id="ex_diur_festdomin" value="{{ old('ex_diur_festdomin') }}">
                                    @error('ex_diur_festdomin')
                                    <small style="color: red">{{ $message }}</small>
                                    @enderror
                                </td>
                                <td><input type="number" class="form-control suma_horasExtras" name="ex_noct_festdomin"
                                        placeholder="0" id="ex_noct_festdomin" value="{{ old('ex_noct_festdomin') }}">
                                ...
                                <td><input type="number" class="form-control suma_recargos" name="recargo_diur_fest"
                                        placeholder="0" id="recargo_diur_fest" value="{{ old('recargo_diur_fest') }}">
                                    @error('recargo_diur_fest')
                                    <small style="color: red">{{ $message }}</small>
                                    @enderror
                                </td>
                                <td><input type="number" class="form-control suma_recargos" name="recargo_noct_fest"
                                        placeholder="0" id="recargo_noct_fest" value="{{ old('recargo_noct_fest') }}">
                                    @error('recargo_noct_fest')
                                    <small style="color: red">{{ $message }}</small>
                                    @enderror
                                </td>
                                <td><input type="number" class="form-control suma_recargos" name="recargo_ord_fest_noct"
                                        placeholder="0" id="recargo_ord_fest_noct"
