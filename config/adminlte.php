...
return [
  ...
  */
  ...
  'logo' => '<b>AuroraSoft SM</b>',
  // 'logo_img' => '../public/image/20 ANIVERSARIO.avif', // Asegúrate de que la ruta sea correcta
  'logo_img_class' => 'brand-image bg-light elevation-0', // Clases CSS para la imagen del logo
  'logo_img_xl' => false,
  ...
  */
  ...
  'preloader' => [
    ...
    'mode' => 'fullscreen',
    'img' => [
      'path' => '../public/image/SM_CIRCULAR.png',
  ...
  */
  ...
  'menu' => [
    ...
    [
      'text' => 'Horas Extras',
      'icon' => 'fas fa-clock',
      'classes' => 'bg-green text-light',
      'submenu' => [
        [
          'text' => 'Mis Horas Extras',
          'url' => 'admin/horas_extras',
